export class AboutScene extends Phaser.Scene{constructor(){super('AboutScene');}create(){this.cameras.main.fadeIn(220,0,0,0);this.add.text(900,40,'ستارلايت: ما دون النجوم',{fontFamily:'Tahoma',fontSize:'34px',color:'#f1e7c7',rtl:true}).setOrigin(1,0);
